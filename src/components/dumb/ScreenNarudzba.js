...
export default class ScreenNarudzba extends React.Component {
  constructor(props) {
    ...
    this.kosaricaToState = this.kosaricaToState.bind(this);

    //tu bi se trebalo povuci iz localstorage
  ...
  kosaricaToState(){
    ...
    this.setState({kosarica:KOSARICA})
  }
  ...
  validForm() {
    ...
    const isEnabled =
      imePrezime.length > 0 && adresa.length > 0 && grad.length > 0;
  ...
  async sendOrder() {
    ...
    //   var slobodnoZaNarucit = await fetch(
    //     "https://webhooks.mongodb-stitch.com/api/client/v2.0/app/saljidaljeserver-krkzo/service/api/incoming_webhook/checkIfNotSold?identifikator=" +
    //       identifikator,
    //     { method: "GET" }
    //   );
      var free = true;
      //await slobodnoZaNarucit.json();
      ...
      if (free || this.state.artikl.ponovnoSeMozeKupiti === true) {
        ...
        var narudzba = await fetch(
          "https://webhooks.mongodb-stitch.com/api/client/v2.0/app/saljidaljeserver-krkzo/service/api/incoming_webhook/spremiNarudzbu",
          {
            method: "POST",
        ...
        {this.state.loading ? (
          ...
          <div>
            <div class="container box bgrGreen ">
              ...
              {/* {JSON.stringify(this.state.kosarica)} */}
              <progress
                class="progress is-primary is-custom"
                value="85"
                max="100"
              >
                50%
                  ...
                  <div class="field-body">
                    <div class="field is-expanded">
                      <div class="field has-addons">
                        <p class="">
                          Još samo malo :) Unesi Podatke i adresu. Plaćanje je
                          pouzećem kada paket stigne
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="field is-horizontal">
                  ...
                  <div class="field-body">
                    <div class="field is-expanded">
                      <div class="field has-addons">
                        <p class="control is-expanded has-icons-left has-icons-right">
                          <input
                            class="input"
                            type="text"
                            data-testid="imeprezime"
                            placeholder="Ime i Prezime"
                            value={
                              this.state.saveMyData
                                ? XLoacalStore.get("imePrezime")
                                : null
                            }
                            name="imePrezime"
                      ...
                      <p class="help">
                        {" "}
                        Dopiši molim te prezime koje se nalazi na tvom
                        poštanskom sandučiću ako nije isto kao tvoje
                      </p>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="field is-expanded">
                      <div class="field has-addons">
                        <p class="control is-expanded has-icons-left has-icons-right">
                          <input
                            class="input"
                            data-testid="postagrad"
                            type="text"
                            placeholder="Poštanski Broj i Grad"
                            value={
                              this.state.saveMyData
                                ? XLoacalStore.get("grad")
                                : null
                            }
                            name="grad"
                            onChange={this.handleChange}
                ...
                <div class="field is-horizontal">
                  ...
                  <div class="field-body">
                    <div class="field is-expanded">
                      ...
                      <p class="help">
                        A može i email adresa ako više preferiraš tako
                      </p>
                      <br />
                      <label class="checkbox">
                        <input
                          ...
                          onChange={this.handleChange}
                        />
                        Ubaci me i na e-mail listu kako bi ti javili za nove
                        artikle prije nego se pojave u webshopu
                      </label>
                    </div>
                  </div>
                </div>
                ...
                <div class="field is-horizontal">
                  ...
                  <div class="field-body">
                    <div class="field is-expanded">
                      <div class="field has-addons">
                        <p class="control">
                          <a class="button is-static">+385</a>
                        </p>
                        <p class="control is-expanded has-icons-right">
                          <input
                            ...
                            type="tel"
                            data-testid="mob"
                            placeholder="Tvoj Broj Mobitela"
                            value={
                              this.state.saveMyData
                                ? XLoacalStore.get("mob")
                                : null
                            }
                            name="mob"
                            onChange={this.handleChange}
                      ...
                      <p class="help">
                        Trebamo tvoj kontakt kako bi se mogli javit u vezi s
                        narudžbom ako bude trebalo radi nekog razloga
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div class="field is-horizontal">
                  ...
                  <div class="field-body">
                    <div class="field is-expanded">
                      <div class="field has-addons">
                        <p class="help">
                          Ili da te kontaktiramo preko IG profila
                        </p>
                ...
                <div class="field is-horizontal">
                  ...
                  <div class="field-body">
                    <div class="field">
                      <div class="control">
                        <button
                          class="button bgrOrange pastelText is-large is-fullwidth"
                          data-testid="posaljiNarudzbu"
